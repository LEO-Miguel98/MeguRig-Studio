...
const fakeControls={headX:{value:"12"},headY:{value:"-8"},bodyZ:{value:"4"},eyeOpen:{value:"76"},mouthOpen:{value:"42"}};const values=MeguRendererIntegration.valuesFromControls(fakeControls);assert.deepEqual(values,{ParamAngleX:12,ParamAngleY:-8,ParamBodyAngleZ:4,ParamEyeOpen:.76,ParamMouthOpenY:.42});
